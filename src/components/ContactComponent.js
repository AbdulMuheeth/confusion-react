...
import { BreadcrumbItem,Button, Form , FormGroup,Label, Input,Col, PopperTargetHelper, timeoutsShape, FormFeedback } from 'reactstrap';
...
class Contact extends Component{   
    ...
    handleSubmit(event){
        ...
        alert("Current state is: "+JSON.stringfy(this.state));    
    ...
    validate(firstname,lastname,telnum,email){
        ...
        if(this.state.touched.telnum && !reg.test(telnum))
            errors.telnum = 'Tel.num should be =10 numbers and must contain only numbers';
